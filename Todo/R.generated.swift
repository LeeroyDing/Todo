...
struct R {
  ...
  struct reuseIdentifier {
    static var todoCell: ReuseIdentifier<TodoTableViewCell> { return ReuseIdentifier(identifier: "todoCell") }
  }
...
struct _R {
  static var hostingBundle: NSBundle? { return NSBundle(identifier: "im.leeroy.Todo") }
